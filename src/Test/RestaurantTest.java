...
class RestaurantTest {
    ...
    List<item> total_option = new Arraylist<item>();
    ...
    public void order_value_should_get_cumulative_total_when_collection_of_items_selected(){
        restaurantCreation();
        total_option = restaurant.getMenu();
        assertEquals(506,restaurant.getOrderValue(total_option));
    }
    ...
    public void order_value_should_reduce_cumulative_total_when_an_item_removed(){
        ...
        int afterTotal = total_option.get(1).getPrice();
        total_option.remove(1);
        assertEquals(total-afterTotal,restaurant.getOrderValue(total_option));
    }
    //<<<<<<<<<<<<<<<<<<<<<<<<<ORDER VALUE>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
